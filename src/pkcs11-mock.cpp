...
CK_DEFINE_FUNCTION(CK_RV, C_GetInfo)(CK_INFO_PTR pInfo)
{
	...
	memcpy(pInfo->manufacturerID,
		   PKCS11_MOCK_CK_INFO_MANUFACTURER_ID_TEXTS,
		   strlen(PKCS11_MOCK_CK_INFO_MANUFACTURER_ID_TEXTS));
	...
	memcpy(pInfo->libraryDescription,
		   PKCS11_MOCK_CK_INFO_LIBRARY_DESCRIPTION_T,
		   strlen(PKCS11_MOCK_CK_INFO_LIBRARY_DESCRIPTION_T));
	// 设置本PKCS11库版本 --------------------------------------------------
