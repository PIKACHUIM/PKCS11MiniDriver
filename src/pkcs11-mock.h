...
#define PKCS11_MOCK_CK_INFO_MANUFACTURER_ID_TEXTS "Pikachu SmartCard MiniDriver"
#define PKCS11_MOCK_CK_INFO_LIBRARY_DESCRIPTION_T "Pikachu CSP PKCS #11 Library"
#define PKCS11_MOCK_CK_INFO_LIBRARY_VERSION_MAJOR 0x01  // 制造商驱动主要版本号
#define PKCS11_MOCK_CK_INFO_LIBRARY_VERSION_MINOR 0x00  // 制造商驱动次要版本号

#define PKCS11_MOCK_CK_SLOT_ID 1
#define PKCS11_MOCK_CK_SLOT_INFO_SLOT_DESCRIPTION "Pikachu Cloud SmartCard Slot"
#define PKCS11_MOCK_CK_SLOT_INFO_MANUFACTURER_ID  "Pikachu Cloud SmartCard Sign"
...
#define PKCS11_MOCK_CK_TOKEN_INFO_MAX_PIN_LEN 32
