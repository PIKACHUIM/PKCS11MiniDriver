...
import {
  Form, Input, Button, Tabs, message, Typography, Space,
} from 'antd';
import {
  UserOutlined, LockOutlined, MailOutlined, IdcardOutlined, SafetyOutlined,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderRadius: '50%', background: 'rgba(22,119,255,0.05)',
      ...
      <div style={{
        ...
        <Space direction="vertical" align="center" style={{ width: '100%', marginBottom: 32 }}>
          ...
          <Title level={3} style={{ margin: 0, color: '#e6edf3', fontWeight: 700, letterSpacing: '-0.5px' }}>
            OpenCert
          </Title>
          <Text style={{ color: '#8b949e', fontSize: 13 }}>企业级证书管理平台</Text>
        </Space>
              ...
              children: (
                <Form layout="vertical" onFinish={handleLogin} size="large" style={{ marginTop: 8 }}>
                  ...
                  <Form.Item style={{ marginBottom: 0, marginTop: 8 }}>
                    <Button
                      type="primary" htmlType="submit" block loading={loginLoading}
                      style={{ height: 44, borderRadius: 8, fontWeight: 600, fontSize: 15,
                        background: 'linear-gradient(135deg, #1677ff, #0958d9)',
                        border: 'none', boxShadow: '0 4px 16px rgba(22,119,255,0.4)' }}
                    >
                      登录
                    </Button>
                  </Form.Item>
              ...
              children: (
                <Form layout="vertical" onFinish={handleRegister} size="large" style={{ marginTop: 8 }}>
                  ...
                  <Form.Item name="display_name" rules={[{ required: true, message: '请输入显示名称' }]}>
                    <Input
                      prefix={<IdcardOutlined style={{ color: '#8b949e' }} />}
                      placeholder="显示名称"
                      style={{ background: 'rgba(13,17,23,0.6)', border: '1px solid rgba(48,54,61,0.8)', color: '#e6edf3', borderRadius: 8 }}
                    />
                  </Form.Item>
                  ...
                  <Form.Item style={{ marginBottom: 0, marginTop: 8 }}>
                    <Button
                      ...
                      style={{ height: 44, borderRadius: 8, fontWeight: 600, fontSize: 15,
                        ...
                        border: 'none', boxShadow: '0 4px 16px rgba(114,46,209,0.4)' }}
                    >
                      注册账号
                    </Button>
                  </Form.Item>
