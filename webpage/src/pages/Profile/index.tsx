      ...
      children: (
        <div style={{ maxWidth: 480 }}>
          ...
          <Form form={infoForm} layout="vertical" onFinish={handleUpdateInfo}>
            ...
            <Form.Item>
              <Button type="primary" htmlType="submit" loading={infoLoading}>保存修改</Button>
            </Form.Item>
          </Form>
        </div>
      ),
      ...
      children: (
        <div style={{ maxWidth: 480 }}>
          <Form form={pwdForm} layout="vertical" onFinish={handleChangePassword}>
            ...
            <Form.Item label="确认新密码" name="confirm" rules={[{ required: true, message: '请确认新密码' }]}>
      ...
      children: (
        <div style={{ maxWidth: 560 }}>
          ...
          <Form form={pubkeyForm} layout="vertical" onFinish={handleUpdatePubkey}>
            <Form.Item label="公钥（PEM 格式）" name="pubkey_pem" rules={[{ required: true, message: '请输入公钥' }]}>
              <Input.TextArea
                rows={8}
            ...
            <Form.Item>
              <Space>
                <Button type="primary" htmlType="submit" loading={pubkeyLoading} icon={<UploadOutlined />}>
                  上传公钥
                </Button>
                <Upload
                  accept=".pem,.crt,.cer"
                  ...
                  beforeUpload={(file) => {
                    ...
                    reader.onload = (e) => {
                      pubkeyForm.setFieldValue('pubkey_pem', e.target?.result as string);
                    };
