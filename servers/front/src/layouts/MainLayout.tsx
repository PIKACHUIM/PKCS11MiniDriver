...
const MainLayout: React.FC = () => {
  ...
  const menuItems: any[] = [
    {
      key: 'group-overview', icon: <DashboardOutlined />, label: '概览',
      children: [
        { key: '/dashboard', icon: <DashboardOutlined />, label: '仪表盘' },
      ],
    },
    {
      key: 'group-mine', icon: <SafetyCertificateOutlined />, label: '我的',
      children: [
    ...
    {
      key: 'group-system', icon: <SettingOutlined />, label: '系统',
      children: [
